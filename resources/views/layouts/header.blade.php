...
<div class="wrapper">
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:#3A3A80;color:white;">
    ...
    <!-- <a href="#" class="brand-link">
      <img src="/assets/images/testimonial/VCA_logo5.png" style="height:100px;width:220px;" alt="dp" class="img-thumbnail w-100"
           style="opacity: .8">
       </a> -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{route('user.edit')}}" title="user profile" class="d-block">{{ Auth::user()->username }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <p style="color:white">Medical Slips</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="{{route('admin-police-invitations')}}" class="nav-link">
      ...
      <li class="nav-item">
        <a href="{{route('admin-police-records')}}" class="nav-link">
        ...
        <li class="nav-item">
        <a href="{{route('admin-court-records')}}" class="nav-link">
        ...
        <li class="nav-item">
          <a href="{{route('admin-prison-records')}}" class="nav-link">
          <i class="fas fa-money-bill-wave text-white"></i>
