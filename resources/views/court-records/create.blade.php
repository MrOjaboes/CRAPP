            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="defendant_name" id="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Offence</label>
                 <input type="text" name="offence_nature" class="form-control" id="">
                </div>
              ...
              <div class="col-md-6">
                ...
                <!-- /.form-group -->
                   <div class="form-group">
                     ...
                     <input type="date" name="arraignment_date" class="form-control">
                   </div>
