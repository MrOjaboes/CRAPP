      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
                    ...
                    <br><br>
            <form action="{{route('admin-police-record')}}" method="POST">
              @csrf
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Name Of Suspect</label>
                  <input type="text" class="form-control" name="suspect_name" id="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>File Number</label>
                 <input type="text"  name="file_number" class="form-control" id="">
                </div>

                <div class="form-group">
                  <label>Police Formation</label>
                 <input type="text" name="police_formation" class="form-control" id="">
                </div>
                
                <div class="form-group">
                <label for="">Date Of Arrest</label>
               <input type="date" name="date_of_arrest" class="form-control">
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nature Of Offence</label>
                   <input type="text" name="nature_of_offence" class="form-control">
                </div>
                <!-- /.form-group -->
                   <div class="form-group">
