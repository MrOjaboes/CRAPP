            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" value="{{$police_record->suspect_name}}" class="form-control" name="suspect_name" id="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>File Number</label>
                 <input type="text" value="{{$police_record->file_number}}"  name="file_number" class="form-control" id="">
                </div>

                <div class="form-group">
                  <label>Police Formation</label>
                 <input type="text" value="{{$police_record->police_formation}}" name="police_formation" class="form-control" id="">
                </div>
                
                <div class="form-group">
                <label for="">Date Of Arrest</label>
               <input type="date" value="{{$police_record->date_of_arrest}}" name="date_of_arrest" class="form-control">
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nature Of Offence</label>
                   <input type="text" value="{{$police_record->nature_of_offence}}" name="nature_of_offence" class="form-control">
                </div>
                <!-- /.form-group -->
                   <div class="form-group">
                     <label for="">Admin Suspect</label>
                     <select name="admin_suspect" class="form-control">
                ...
                <div class="form-group">
                  <label>Remarks</label>
                <textarea name="remarks" value="{{$police_record->remarks}}" class="form-control">{{$police_record->remarks}}</textarea>
                  <!-- /.input group -->
                </div>
